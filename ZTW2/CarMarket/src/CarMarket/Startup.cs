...
namespace CarMarket
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            bool useInMemoryProvider = bool.Parse(Configuration["Data:CarMarketConnection:InMemoryProvider"]);

            services.AddDbContext<CarMarketContext>(options => {
